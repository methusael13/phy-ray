...
const Real CopperWavelengths[CopperSamples] = {
...
const Real CopperN[CopperSamples] = {
...
const Real CopperK[CopperSamples] = {
...
MetalMaterial* createMetalMaterial(Real rough) {
    static Spectrum copperN =
        Spectrum::getFromSample(CopperWavelengths, CopperN, CopperSamples);
    std::shared_ptr<Texture<Spectrum>> eta =
        std::make_shared<ConstantTexture<Spectrum>>(copperN);

    static Spectrum copperK =
        Spectrum::getFromSample(CopperWavelengths, CopperK, CopperSamples);
    std::shared_ptr<Texture<Spectrum>> k =
            std::make_shared<ConstantTexture<Spectrum>>(copperK);
